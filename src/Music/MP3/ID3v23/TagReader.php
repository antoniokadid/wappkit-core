...
use AntonioKadid\WAPPKitCore\IO\Streams\Stream;
use AntonioKadid\WAPPKitCore\IO\Streams\TempStream;
use AntonioKadid\WAPPKitCore\Music\MP3\ID3v23\Frames\CommentFrame;
use AntonioKadid\WAPPKitCore\Music\MP3\ID3v23\Frames\PictureFrame;
use AntonioKadid\WAPPKitCore\Music\MP3\ID3v23\Frames\TextFrame;
 ...
 *
 * @package AntonioKadid\WAPPKitCore\Music
 */
class TagReader
{
    /**
    ...
    public function getTags(string $filename): array
    {
        ...
        $fileStream = new Stream($filename, 'rb');
